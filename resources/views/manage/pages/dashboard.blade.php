...
@section('content')
    ...
    <div class="py-2">
        <div class="row mb-3">
            ...
            <!-- Metric -->
            <div class="col-xl-3 col-md-6 mb-4">
                <x-widgets.metric label="Draft Stories" value="{{ $totals['stories'] }}" color="warning" icon="bi bi-page" />
            </div>
            ...
            <!-- Metric -->
            <div class="col-xl-3 col-md-6 mb-4">
               <x-widgets.metric label="Pending Comments" value="{{ $totals['comments'] }}" color="warning" icon="bi bi-chat" />
            </div>
        </div>

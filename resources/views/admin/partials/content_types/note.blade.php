    ...
    <div class="card-body row">
        <div class="col-lg-6">
            <div class="mb-3">
                ...
                <input type="text" name="subject" class="form-control" id="subject" value="{{ $content->subject ?? '' }}"aria-describedby="subjectHelp">
        ...
        <div class="col-lg-12">
            <div class="mb-3">
                ...
                <textarea class="form-control" name="body" id="editor" style="height: 100px">{{ $content->body ?? '' }}</textarea>

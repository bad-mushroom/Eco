<x-card>
    ...
    <x-slot:body>
        <div class="mb-3">
            ...
            <div id="content-type" class="form-text">The type of story this is.</div>
        </div>
        <div class="mb-3">
            <label for="user-id" class="form-label">Author</label>
            <select class="form-control" name="user_id" id="user-id" aria-describedby="authorHelp" @if ($story) disabled @endif>
...
<x-card>
    ...
    <x-slot:body>
        ...
        @if ($story && $story->featured_image)
            <div class="text-center mb-3">
                <img src="data:image/png;base64,{{ $story->featured_image }}" class="img-fluid border border-light" />
            </div>
        @endif
